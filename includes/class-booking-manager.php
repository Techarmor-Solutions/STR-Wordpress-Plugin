...
class BookingManager {
	...
	public function create_booking( array $data ): int|\WP_Error {
		...
		$meta_map = array(
			...
			'str_taxes'                 => 'taxes',
			'str_management_fee'        => 'management_fee',
			'str_management_fee_pct'    => 'management_fee_pct',
			'str_total'                 => 'total',
	...
	public function get_booking( int $id ): array|\WP_Error {
		...
		return array(
			...
			'management_fee'         => (float) get_post_meta( $id, 'str_management_fee', true ),
			'management_fee_pct'     => (float) get_post_meta( $id, 'str_management_fee_pct', true ),
